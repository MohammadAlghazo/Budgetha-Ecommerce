### File: src/Budgetha.API/Contracts/Auth/AuthContracts.cs
```csharp
...
### File: src/Budgetha.API/Controllers/AdminController.cs
```csharp
...
### File: src/Budgetha.API/Controllers/AnnouncementsController.cs
```csharp
...
### File: src/Budgetha.API/Controllers/AuthController.cs
```csharp
...
### File: src/Budgetha.API/Controllers/CategoriesController.cs
```csharp
...
### File: src/Budgetha.API/Controllers/ImagesController.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using Microsoft.AspNetCore.Authorization;
...
### File: src/Budgetha.API/Controllers/OrdersController.cs
```csharp
...
### File: src/Budgetha.API/Controllers/ProductsController.cs
```csharp
...
### File: src/Budgetha.API/Controllers/ReviewsController.cs
```csharp
...
### File: src/Budgetha.API/Controllers/RolesController.cs
```csharp
using Budgetha.API.Contracts.Auth;
using Budgetha.Application.Common.Interfaces;
using Microsoft.AspNetCore.Authorization;
...
### File: src/Budgetha.API/Controllers/SellerRequestsController.cs
```csharp
...
### File: src/Budgetha.API/Middleware/GlobalExceptionMiddleware.cs
```csharp
using System.Net;
...
### File: src/Budgetha.API/Program.cs
```csharp
...
### File: src/Budgetha.API/Services/CurrentUserService.cs
```csharp
...
### File: src/Budgetha.Application/Common/Behaviours/UnhandledExceptionBehaviour.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using MediatR;
...
### File: src/Budgetha.Application/Common/Exceptions/ApplicationExceptions.cs
```csharp
...
### File: src/Budgetha.Application/Common/Interfaces/IAdminService.cs
```csharp
using System;
...
### File: src/Budgetha.Application/Common/Interfaces/IApplicationDbContext.cs
```csharp
...
### File: src/Budgetha.Application/Common/Interfaces/ICurrentUserService.cs
```csharp
namespace Budgetha.Application.Common.Interfaces;
...
### File: src/Budgetha.Application/Common/Interfaces/IDateTimeService.cs
```csharp
namespace Budgetha.Application.Common.Interfaces;
...
### File: src/Budgetha.Application/Common/Interfaces/IIdentityService.cs
```csharp
...
### File: src/Budgetha.Application/Common/Interfaces/IImageService.cs
```csharp
using Budgetha.Application.Common.Models;
...
### File: src/Budgetha.Application/Common/Models/AuthResult.cs
```csharp
...
### File: src/Budgetha.Application/Common/Models/ImageUploadResponse.cs
```csharp
namespace Budgetha.Application.Common.Models;
...
### File: src/Budgetha.Application/DependencyInjection/ApplicationServiceRegistration.cs
```csharp
...
### File: src/Budgetha.Application/Features/Announcements/Commands/CreateAnnouncementCommand.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using Budgetha.Domain.Entities;
using MediatR;
...
### File: src/Budgetha.Application/Features/Announcements/Commands/DeleteAnnouncementCommand.cs
```csharp
using Budgetha.Application.Common.Exceptions;
using Budgetha.Application.Common.Interfaces;
using Budgetha.Domain.Entities;
...
### File: src/Budgetha.Application/Features/Announcements/Commands/UpdateAnnouncementCommand.cs
```csharp
using Budgetha.Application.Common.Exceptions;
using Budgetha.Application.Common.Interfaces;
using Budgetha.Domain.Entities;
...
### File: src/Budgetha.Application/Features/Announcements/Queries/GetActiveAnnouncementQuery.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using MediatR;
using Microsoft.EntityFrameworkCore;
...
### File: src/Budgetha.Application/Features/Announcements/Queries/GetAllAnnouncementsQuery.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using MediatR;
using Microsoft.EntityFrameworkCore;
...
### File: src/Budgetha.Application/Features/Categories/Commands/CreateCategoryCommand.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using Budgetha.Domain.Entities;
using MediatR;
...
### File: src/Budgetha.Application/Features/Categories/Commands/UpdateCategoryCommand.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using Budgetha.Domain.Entities;
using MediatR;
...
### File: src/Budgetha.Application/Features/Categories/Queries/CategoryDto.cs
```csharp
...
### File: src/Budgetha.Application/Features/Categories/Queries/GetCategoriesQuery.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using MediatR;
using Microsoft.EntityFrameworkCore;
...
### File: src/Budgetha.Application/Features/Orders/DTOs/TransactionHistoryDto.cs
```csharp
...
### File: src/Budgetha.Application/Features/Orders/Queries/GetTransactionHistoryQuery.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using Budgetha.Application.Features.Orders.DTOs;
using MediatR;
...
### File: src/Budgetha.Application/Features/Products/Commands/ApproveProductCommand.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using Budgetha.Domain.Enums;
using MediatR;
...
### File: src/Budgetha.Application/Features/Products/Commands/CreateProductCommand.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using Budgetha.Domain.Entities;
using Budgetha.Domain.Enums;
...
### File: src/Budgetha.Application/Features/Products/Commands/DeleteProductCommand.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using MediatR;
using System;
...
### File: src/Budgetha.Application/Features/Products/Commands/UpdateProductCommand.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using Budgetha.Domain.Entities;
using MediatR;
...
### File: src/Budgetha.Application/Features/Products/Queries/GetBrandsQuery.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using MediatR;
using Microsoft.EntityFrameworkCore;
...
### File: src/Budgetha.Application/Features/Products/Queries/GetProductBySlugQuery.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using MediatR;
using Microsoft.EntityFrameworkCore;
...
### File: src/Budgetha.Application/Features/Products/Queries/GetProductsQuery.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using Budgetha.Domain.Enums;
using MediatR;
...
### File: src/Budgetha.Application/Features/Products/Queries/ProductDto.cs
```csharp
namespace Budgetha.Application.Features.Products.Queries;
...
### File: src/Budgetha.Application/Features/Reviews/Commands/AddReviewCommand.cs
```csharp
using Budgetha.Application.Common.Exceptions;
using Budgetha.Application.Common.Interfaces;
using Budgetha.Domain.Entities;
...
### File: src/Budgetha.Application/Features/Reviews/Commands/DeleteReviewCommand.cs
```csharp
using Budgetha.Application.Common.Exceptions;
using Budgetha.Application.Common.Interfaces;
using Budgetha.Domain.Entities;
...
### File: src/Budgetha.Application/Features/Reviews/Commands/UpdateReviewCommand.cs
```csharp
using Budgetha.Application.Common.Exceptions;
using Budgetha.Application.Common.Interfaces;
using Budgetha.Domain.Entities;
...
### File: src/Budgetha.Application/Features/Reviews/Queries/GetProductReviewsQuery.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using Budgetha.Domain.Entities;
using MediatR;
...
### File: src/Budgetha.Application/Features/SellerRequests/Commands/ApproveSellerRequestCommand.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using MediatR;
using Microsoft.EntityFrameworkCore;
...
### File: src/Budgetha.Application/Features/SellerRequests/Commands/RejectSellerRequestCommand.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using MediatR;
using Microsoft.EntityFrameworkCore;
...
### File: src/Budgetha.Application/Features/SellerRequests/Commands/SubmitSellerRequestCommand.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using Budgetha.Domain.Entities;
using MediatR;
...
### File: src/Budgetha.Application/Features/SellerRequests/Queries/GetSellerRequestsQuery.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using MediatR;
using Microsoft.EntityFrameworkCore;
...
### File: src/Budgetha.Domain/Common/BaseAuditableEntity.cs
```csharp
...
### File: src/Budgetha.Domain/Common/BaseEntity.cs
```csharp
namespace Budgetha.Domain.Common;
...
### File: src/Budgetha.Domain/Common/BaseEvent.cs
```csharp
using MediatR;
...
### File: src/Budgetha.Domain/Entities/Address.cs
```csharp
...
### File: src/Budgetha.Domain/Entities/Announcement.cs
```csharp
using Budgetha.Domain.Common;
...
### File: src/Budgetha.Domain/Entities/ApplicationUser.cs
```csharp
using Budgetha.Domain.Common;
using Budgetha.Domain.Enums;
...
### File: src/Budgetha.Domain/Entities/Cart.cs
```csharp
using Budgetha.Domain.Common;
...
### File: src/Budgetha.Domain/Entities/CartItem.cs
```csharp
using Budgetha.Domain.Common;
using Budgetha.Domain.Enums;
...
### File: src/Budgetha.Domain/Entities/Category.cs
```csharp
using Budgetha.Domain.Common;
using Budgetha.Domain.Enums;
...
### File: src/Budgetha.Domain/Entities/Order.cs
```csharp
using Budgetha.Domain.Common;
using Budgetha.Domain.Enums;
...
### File: src/Budgetha.Domain/Entities/OrderItem.cs
```csharp
using Budgetha.Domain.Common;
using Budgetha.Domain.Enums;
...
### File: src/Budgetha.Domain/Entities/Payment.cs
```csharp
using Budgetha.Domain.Common;
using Budgetha.Domain.Enums;
...
### File: src/Budgetha.Domain/Entities/Product.cs
```csharp
using Budgetha.Domain.Common;
using Budgetha.Domain.Enums;
...
### File: src/Budgetha.Domain/Entities/ProductImage.cs
```csharp
using Budgetha.Domain.Common;
...
### File: src/Budgetha.Domain/Entities/Review.cs
```csharp
using Budgetha.Domain.Common;
...
### File: src/Budgetha.Domain/Entities/SellerRequest.cs
```csharp
using Budgetha.Domain.Common;
...
### File: src/Budgetha.Domain/Entities/SellerVerification.cs
```csharp
using Budgetha.Domain.Common;
using Budgetha.Domain.Enums;
...
### File: src/Budgetha.Domain/Entities/SupportTicket.cs
```csharp
using Budgetha.Domain.Common;
using Budgetha.Domain.Enums;
...
### File: src/Budgetha.Domain/Entities/Wishlist.cs
```csharp
using Budgetha.Domain.Common;
...
### File: src/Budgetha.Domain/Enums/ApprovalStatus.cs
```csharp
...
### File: src/Budgetha.Domain/Enums/OrderItemType.cs
```csharp
namespace Budgetha.Domain.Enums;
...
### File: src/Budgetha.Domain/Enums/OrderStatus.cs
```csharp
namespace Budgetha.Domain.Enums;
...
### File: src/Budgetha.Domain/Enums/PaymentProvider.cs
```csharp
namespace Budgetha.Domain.Enums;
...
### File: src/Budgetha.Domain/Enums/PaymentStatus.cs
```csharp
namespace Budgetha.Domain.Enums;
...
### File: src/Budgetha.Domain/Enums/TicketStatus.cs
```csharp
namespace Budgetha.Domain.Enums;
...
### File: src/Budgetha.Domain/Enums/VerificationStatus.cs
```csharp
namespace Budgetha.Domain.Enums;
...
### File: src/Budgetha.Infrastructure/Authentication/IdentityService.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using Budgetha.Application.Common.Models;
using Budgetha.Domain.Entities;
...
### File: src/Budgetha.Infrastructure/Authentication/JwtSettings.cs
```csharp
namespace Budgetha.Infrastructure.Authentication;
...
### File: src/Budgetha.Infrastructure/Authentication/TokenService.cs
```csharp
...
### File: src/Budgetha.Infrastructure/DependencyInjection/InfrastructureServiceRegistration.cs
```csharp
using System.Text;
using Budgetha.Application.Common.Interfaces;
using Budgetha.Domain.Entities;
...
### File: src/Budgetha.Infrastructure/Persistence/ApplicationDbContext.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using Budgetha.Domain.Common;
using Budgetha.Domain.Entities;
...
### File: src/Budgetha.Infrastructure/Persistence/ApplicationDbInitializer.cs
```csharp
using Budgetha.Domain.Entities;
using Microsoft.AspNetCore.Identity;
using Microsoft.Extensions.DependencyInjection;
...
### File: src/Budgetha.Infrastructure/Persistence/Configurations/AddressConfiguration.cs
```csharp
using Budgetha.Domain.Entities;
using Microsoft.EntityFrameworkCore;
...
### File: src/Budgetha.Infrastructure/Persistence/Configurations/ApplicationUserConfiguration.cs
```csharp
using Budgetha.Domain.Entities;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
...
### File: src/Budgetha.Infrastructure/Persistence/Configurations/CartConfiguration.cs
```csharp
using Budgetha.Domain.Entities;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
...
### File: src/Budgetha.Infrastructure/Persistence/Configurations/CartItemConfiguration.cs
```csharp
using Budgetha.Domain.Entities;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
...
### File: src/Budgetha.Infrastructure/Persistence/Configurations/CategoryConfiguration.cs
```csharp
using Budgetha.Domain.Entities;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
...
### File: src/Budgetha.Infrastructure/Persistence/Configurations/OrderConfiguration.cs
```csharp
using Budgetha.Domain.Entities;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
...
### File: src/Budgetha.Infrastructure/Persistence/Configurations/OrderItemConfiguration.cs
```csharp
using Budgetha.Domain.Entities;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
...
### File: src/Budgetha.Infrastructure/Persistence/Configurations/PaymentConfiguration.cs
```csharp
using Budgetha.Domain.Entities;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
...
### File: src/Budgetha.Infrastructure/Persistence/Configurations/ProductConfiguration.cs
```csharp
using Budgetha.Domain.Entities;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
...
### File: src/Budgetha.Infrastructure/Persistence/Configurations/ProductImageConfiguration.cs
```csharp
using Budgetha.Domain.Entities;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
...
### File: src/Budgetha.Infrastructure/Persistence/Configurations/ReviewConfiguration.cs
```csharp
using Budgetha.Domain.Entities;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
...
### File: src/Budgetha.Infrastructure/Persistence/Configurations/SellerVerificationConfiguration.cs
```csharp
using Budgetha.Domain.Entities;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
...
### File: src/Budgetha.Infrastructure/Persistence/Configurations/SupportTicketConfiguration.cs
```csharp
using Budgetha.Domain.Entities;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
...
### File: src/Budgetha.Infrastructure/Persistence/Configurations/TicketMessageConfiguration.cs
```csharp
using Budgetha.Domain.Entities;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
...
### File: src/Budgetha.Infrastructure/Persistence/Configurations/WishlistConfiguration.cs
```csharp
using Budgetha.Domain.Entities;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
...
### File: src/Budgetha.Infrastructure/Persistence/Migrations/20260728122738_InitialCreate.cs
```csharp
﻿using System;
...
### File: src/Budgetha.Infrastructure/Persistence/Migrations/20260730140833_AddApprovalStatus.cs
```csharp
﻿using Microsoft.EntityFrameworkCore.Migrations;
...
### File: src/Budgetha.Infrastructure/Persistence/Migrations/20260730194728_AddAnnouncements.cs
```csharp
﻿using System;
using Microsoft.EntityFrameworkCore.Migrations;
...
### File: src/Budgetha.Infrastructure/Persistence/Migrations/20260730201331_AddSellerRequests.cs
```csharp
﻿using Microsoft.EntityFrameworkCore.Migrations;
...
### File: src/Budgetha.Infrastructure/Persistence/Migrations/20260730201835_AddSellerRequestsTable.cs
```csharp
﻿using System;
using Microsoft.EntityFrameworkCore.Migrations;
...
### File: src/Budgetha.Infrastructure/Persistence/Migrations/20260731093637_AddProductRealism.cs
```csharp
﻿using Microsoft.EntityFrameworkCore.Migrations;
...
### File: src/Budgetha.Infrastructure/Persistence/Migrations/ApplicationDbContextModelSnapshot.cs
```csharp
﻿// <auto-generated />
using System;
using Budgetha.Infrastructure.Persistence;
...
### File: src/Budgetha.Infrastructure/Services/AdminService.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using Budgetha.Application.Features.Products.Queries;
using Budgetha.Domain.Entities;
...
### File: src/Budgetha.Infrastructure/Services/CloudinarySettings.cs
```csharp
namespace Budgetha.Infrastructure.Services;
...
### File: src/Budgetha.Infrastructure/Services/DateTimeService.cs
```csharp
using Budgetha.Application.Common.Interfaces;
...
### File: src/Budgetha.Infrastructure/Services/ImageService.cs
```csharp
using Budgetha.Application.Common.Interfaces;
using Budgetha.Application.Common.Models;
